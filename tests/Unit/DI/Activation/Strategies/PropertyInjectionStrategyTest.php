...
class PropertyInjectionStrategyTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $directives = [
            new PropertyInjectionDirective(new PropertyReflection(self::class, 'strategy'), function() {
        ...
        $plan->expects($this->any())
             ->method('getAll')
             ->with($this->equalTo(PropertyInjectionDirective::class))
        ...
        $this->strategy = new PropertyInjectionStrategy();
    }
